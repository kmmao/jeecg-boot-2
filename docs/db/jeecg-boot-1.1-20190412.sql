...
CREATE TABLE `onl_cgform_button` (
  ...
  PRIMARY KEY  (`ID`),
  KEY `index_formid` (`CGFORM_HEAD_ID`),
...
CREATE TABLE `onl_cgform_field` (
  ...
  PRIMARY KEY  (`id`),
  KEY `inex_table_id` (`cgform_head_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `onl_cgform_field` VALUES ('04a26d3a168342fb6b7e702dfb18723a', '484aae9dee13465e916184949e28fe14', 'sex', '性别', null, '0', '1', 'String', '32', '0', '', 'sex', '', '', 'list', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '7', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('06c401509379febdd141fdf63598a353', '484aae9dee13465e916184949e28fe14', 'name', '用户名', null, '0', '1', 'String', '200', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '8', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('6d04163cb97486fa3bb0ebceb1323632', '484aae9dee13465e916184949e28fe14', 'content', '请假原因', null, '0', '1', 'String', '500', '0', '', '', '', '', 'textarea', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '9', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('77ca0817fb33bf713ce5f4e48da52320', '484aae9dee13465e916184949e28fe14', 'update_by', '更新人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '4', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('94ebddc2954be871d2b7e37abf3209ca', '484aae9dee13465e916184949e28fe14', 'update_time', '更新日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '5', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('b03fc4f8e5968b367a2da4242534b9e0', '484aae9dee13465e916184949e28fe14', 'be_date', '请假时间', null, '0', '1', 'Date', '32', '0', '', '', '', '', 'date', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '10', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('b53bb0d1c0ed839418ea0d0aa47233f7', '484aae9dee13465e916184949e28fe14', 'create_time', '创建日期', null, '0', '1', 'Date', '20', '0', '', '', '', '', 'datetime', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '3', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('be7f89a7766e63082dabdbd35edee937', '484aae9dee13465e916184949e28fe14', 'create_by', '创建人', null, '0', '1', 'string', '50', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '2', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d3046ea9ef1851cf719734ea458cd7fc', '484aae9dee13465e916184949e28fe14', 'id', '主键', null, '1', '0', 'string', '36', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '0', '0', 'single', '', '', '1', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('f49ad1f8f1a2c290cbeaec603665ede6', '484aae9dee13465e916184949e28fe14', 'qj_days', '请假天数', null, '0', '1', 'int', '10', '0', '', '', '', '', 'text', '', '120', null, '0', '', '', '0', '1', '1', 'single', '', '', '11', 'admin', '2019-04-12 09:47:51', '2019-04-12 09:41:19', 'admin');
...
CREATE TABLE `onl_cgform_head` (
  ...
  `create_time` datetime default NULL COMMENT '创建时间',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `index_onlineform_table_name` (`table_name`),
  KEY `index_form_templdate` (`form_template`),
  KEY `index_templdate_mobile` (`form_template_mobile`),
  KEY `index_onlineform_table_version` (`table_version`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of onl_cgform_head
-- ----------------------------
INSERT INTO `onl_cgform_head` VALUES ('484aae9dee13465e916184949e28fe14', 'test_person', '1', '3', '测试请假表', 'N', 'Y', 'Y', 'N', null, 'UUID', 'single', null, null, null, null, null, null, 'bdfl_include', '1', null, 'admin', '2019-04-12 09:43:01', 'admin', '2019-04-12 09:41:19');
...
CREATE TABLE `onl_cgform_index` (
  ...
  PRIMARY KEY  (`id`),
  KEY `index_table_id` (`cgform_head_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `onl_graphreport_head` (
  ...
  `code` varchar(36) NOT NULL COMMENT '图表编码',
  `cgr_sql` varchar(1000) NOT NULL COMMENT '查询数据SQL',
  `xaxis_field` varchar(1000) NOT NULL COMMENT 'x轴数据字段',
  `yaxis_text` varchar(100) NOT NULL COMMENT 'y轴文字描述',
  `content` varchar(1000) default NULL COMMENT '描述',
  `is_show_list` varchar(5) default NULL COMMENT '是否显示明细',
  `extend_js` varchar(1000) default NULL COMMENT '扩展JS',
  `create_time` datetime default NULL,
  `create_by` varchar(50) default NULL,
  `update_time` datetime default NULL,
  `update_by` varchar(50) default NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY `index_code` USING BTREE (`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `onl_graphreport_item` (
  `id` varchar(32) NOT NULL COMMENT 'id',
  `graphreport_head_id` varchar(36) NOT NULL COMMENT '主表ID',
  ...
  `graph_tab_name` varchar(50) default NULL COMMENT '标签名称',
  `is_graph` varchar(5) default NULL COMMENT '显示图表',
  `is_show` varchar(5) default NULL COMMENT '是否列表显示',
  ...
  `field_type` varchar(10) default NULL COMMENT '字段类型',
  `order_num` int(11) default NULL COMMENT '排序',
  `replace_val` varchar(36) default NULL COMMENT '取值表达式',
  `create_by` varchar(32) default NULL COMMENT '创建人',
  `create_time` datetime default NULL COMMENT '创建时间',
  `update_by` varchar(32) default NULL COMMENT '修改人',
  `update_time` datetime default NULL COMMENT '修改时间',
  PRIMARY KEY  (`id`),
  KEY `index_headid` USING BTREE (`graphreport_head_id`),
  KEY `index_isshow` USING BTREE (`is_show`)
...
-- ----------------------------
INSERT INTO `onl_graphreport_item` VALUES ('402881e44cd2a0c2014cd2a0c29d0000', '402881e64ca71152014ca71152480000', 'ct', '操作次数', '操作次数', 'column', '柱状图', 'Y', 'Y', 'Y', 'single', '', null, 'Integer', '1', null, 'admin', '2019-04-11 19:32:32', null, null);
INSERT INTO `onl_graphreport_item` VALUES ('402881e44cd2a0c2014cd2af45210001', '402881e64ca71152014ca71152480000', 'ct', '操作次数', '操作次数', 'spline', '曲线图', 'Y', 'N', 'N', 'single', '', null, 'Integer', '5', null, 'admin', '2019-04-11 19:32:32', null, null);
INSERT INTO `onl_graphreport_item` VALUES ('402881e44cd2a0c2014cd2af45550002', '402881e64ca71152014ca71152480000', 'login_count', '登录次数', '登录次数', 'spline', '曲线图', 'Y', 'N', 'Y', 'single', '', null, 'Integer', '6', null, 'admin', '2019-04-11 19:32:32', null, null);
INSERT INTO `onl_graphreport_item` VALUES ('402881e64ca71152014ca711527c0001', '402881e64ca71152014ca71152480000', 'userid', '用户', '用户', 'spline', '', 'N', 'Y', 'Y', 'single', 'select id \'key\', realname \'value\' from t_s_base_user', null, 'String', '0', null, 'admin', '2019-04-11 19:32:32', null, null);
INSERT INTO `onl_graphreport_item` VALUES ('402881e64ca71152014ca71152a90002', '402881e64ca71152014ca71152480000', 'login_count', '登录次数', '登录次数', 'column', '柱状图', 'Y', 'Y', 'N', 'group', '', null, 'Integer', '2', null, 'admin', '2019-04-11 19:32:32', null, null);
INSERT INTO `onl_graphreport_item` VALUES ('402881e64ca7adc7014ca7adc75a0000', '402881e64ca71152014ca71152480000', 'operatetime', '操作日期', '', 'spline', '', 'N', 'N', 'Y', 'group', '', null, 'Date', '3', null, 'admin', '2019-04-11 19:32:32', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('0ca4beba9efc4f9dd54af0911a946d5c', '72cce0989df68887546746d8f09811aa', '附表', '3', null, '3.00', '1', 'admin', '2019-03-27 10:13:43', null, null);
INSERT INTO `sys_dict_item` VALUES ('147c48ff4b51545032a9119d13f3222a', 'd6e1152968b02d69ff358c75b48a6ee1', '测试流程', 'test', null, '1.00', '1', 'admin', '2019-03-22 19:27:05', null, null);
INSERT INTO `sys_dict_item` VALUES ('1b8a6341163062dad8cb2fddd34e0c3b', '404a04a15f371566c658ee9ef9fc392a', '22', '222', null, '1.00', '1', 'admin', '2019-03-30 11:17:48', null, null);
INSERT INTO `sys_dict_item` VALUES ('1ce390c52453891f93514c1bd2795d44', 'ad7c65ba97c20a6805d5dcdf13cdaf36', '000', '00', null, '1.00', '1', 'admin', '2019-03-22 16:34:34', null, null);
INSERT INTO `sys_dict_item` VALUES ('23a5bb76004ed0e39414e928c4cde155', '4e4602b3e3686f0911384e188dc7efb4', '不等于', '!=', '不等于', '3.00', '1', 'admin', '2019-04-01 16:46:15', 'admin', '2019-04-01 17:48:40');
INSERT INTO `sys_dict_item` VALUES ('25847e9cb661a7c711f9998452dc09e6', '4e4602b3e3686f0911384e188dc7efb4', '小于等于', '<=', '小于等于', '6.00', '1', 'admin', '2019-04-01 16:44:34', 'admin', '2019-04-01 17:49:10');
INSERT INTO `sys_dict_item` VALUES ('41fa1e9571505d643aea87aeb83d4d76', '4e4602b3e3686f0911384e188dc7efb4', '等于', '=', '等于', '4.00', '1', 'admin', '2019-04-01 16:45:24', 'admin', '2019-04-01 17:49:00');
...
INSERT INTO `sys_dict_item` VALUES ('50223341bfb5ba30bf6319789d8d17fe', 'd6e1152968b02d69ff358c75b48a6ee1', '业务办理', 'business', null, '3.00', '1', 'admin', '2023-04-22 19:28:05', 'admin', '2019-03-22 23:24:39');
INSERT INTO `sys_dict_item` VALUES ('5584c21993bde231bbde2b966f2633ac', '4e4602b3e3686f0911384e188dc7efb4', '自定义SQL表达式', 'USE_SQL_RULES', '自定义SQL表达式', '9.00', '1', 'admin', '2019-04-01 10:45:24', 'admin', '2019-04-01 17:49:27');
INSERT INTO `sys_dict_item` VALUES ('58b73b344305c99b9d8db0fc056bbc0a', '72cce0989df68887546746d8f09811aa', '主表', '2', null, '2.00', '1', 'admin', '2019-03-27 10:13:36', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('66c952ae2c3701a993e7db58f3baf55e', '4e4602b3e3686f0911384e188dc7efb4', '大于', '>', '大于', '1.00', '1', 'admin', '2019-04-01 10:45:46', 'admin', '2019-04-01 17:48:29');
INSERT INTO `sys_dict_item` VALUES ('6937c5dde8f92e9a00d4e2ded9198694', 'ad7c65ba97c20a6805d5dcdf13cdaf36', 'easyui', '3', null, '1.00', '1', 'admin', '2019-03-22 16:32:15', null, null);
INSERT INTO `sys_dict_item` VALUES ('6c682d78ddf1715baf79a1d52d2aa8c2', '72cce0989df68887546746d8f09811aa', '单表', '1', null, '1.00', '1', 'admin', '2019-03-27 10:13:29', null, null);
INSERT INTO `sys_dict_item` VALUES ('6d404fd2d82311fbc87722cd302a28bc', '4e4602b3e3686f0911384e188dc7efb4', '模糊', 'LIKE', '模糊', '7.00', '1', 'admin', '2019-04-01 16:46:02', 'admin', '2019-04-01 17:49:20');
...
INSERT INTO `sys_dict_item` VALUES ('71b924faa93805c5c1579f12e001c809', 'd6e1152968b02d69ff358c75b48a6ee1', 'OA办公', 'oa', null, '2.00', '1', 'admin', '2021-03-22 19:27:17', 'admin', '2019-03-22 23:24:36');
...
INSERT INTO `sys_dict_item` VALUES ('84778d7e928bc843ad4756db1322301f', '4e4602b3e3686f0911384e188dc7efb4', '大于等于', '>=', '大于等于', '5.00', '1', 'admin', '2019-04-01 10:46:02', 'admin', '2019-04-01 17:49:05');
...
INSERT INTO `sys_dict_item` VALUES ('8bccb963e1cd9e8d42482c54cc609ca2', '4f69be5f507accea8d5df5f11346181a', '微信', '3', null, '3.00', '1', 'admin', '2021-05-11 14:29:12', 'admin', '2019-04-11 14:29:31');
INSERT INTO `sys_dict_item` VALUES ('8c618902365ca681ebbbe1e28f11a548', '4c753b5293304e7a445fd2741b46529d', '启用', '1', null, '0.00', '0', 'admin', '2019-03-18 23:19:27', 'admin', '2019-03-20 09:33:30');
...
INSERT INTO `sys_dict_item` VALUES ('a2321496db6febc956a6c70fab94cb0c', '404a04a15f371566c658ee9ef9fc392a', '3', '3', null, '1.00', '1', 'admin', '2019-03-30 11:18:18', null, null);
...
INSERT INTO `sys_dict_item` VALUES ('adcf2a1fe93bb99a84833043f475fe0b', '4e4602b3e3686f0911384e188dc7efb4', '包含', 'IN', '包含', '8.00', '1', 'admin', '2019-04-01 16:45:47', 'admin', '2019-04-01 17:49:24');
...
INSERT INTO `sys_dict_item` VALUES ('b4a887dc3ff01d2daadaa412e63189ed', '4f69be5f507accea8d5df5f11346181a', '邮件', '2', null, '2.00', '1', 'admin', '2021-05-11 14:29:03', 'admin', '2019-04-11 14:29:25');
...
INSERT INTO `sys_dict_item` VALUES ('d75b5b3666d0742f08027af0255b4400', '4f69be5f507accea8d5df5f11346181a', '短信', '1', null, '1.00', '1', 'admin', '2019-04-11 14:28:49', null, null);
INSERT INTO `sys_dict_item` VALUES ('df168368dcef46cade2aadd80100d8aa', '3d9a351be3436fbefb1307d4cfb49bf2', '男', '1', null, '1.00', '1', null, '2027-08-04 14:56:49', 'admin', '2019-03-23 22:44:44');
INSERT INTO `sys_dict_item` VALUES ('e6329e3a66a003819e2eb830b0ca2ea0', '4e4602b3e3686f0911384e188dc7efb4', '小于', '<', '小于', '2.00', '1', 'admin', '2019-04-01 16:44:15', 'admin', '2019-04-01 17:48:34');
INSERT INTO `sys_dict_item` VALUES ('f0162f4cc572c9273f3e26b2b4d8c082', 'ad7c65ba97c20a6805d5dcdf13cdaf36', 'booostrap', '1', null, '1.00', '1', 'admin', '2021-08-22 16:32:04', 'admin', '2019-03-22 16:33:57');
...
INSERT INTO `sys_permission` VALUES ('020b06793e4de2eee0007f603000c769', 'f0675b52d89100ee88472b6800754a08', 'ViserChartDemo', '/report/ViserChartDemo', 'jeecg/report/ViserChartDemo', null, null, '1', null, '3.00', '0', null, '1', '1', '0', null, 'admin', '2019-04-03 19:08:53', 'admin', '2019-04-03 19:08:53', '0');
...
INSERT INTO `sys_permission` VALUES ('54097c6a3cf50fad0793a34beff1efdf', 'e41b69c57a941a3bbcce45032fe57605', 'AUTO在线表单', '/online/cgformList/:code', 'modules/online/cgform/auto/OnlCgformAutoList', null, null, '1', null, '5.00', '0', null, '1', '1', '0', null, 'admin', '2019-03-19 16:03:06', 'admin', '2019-04-11 19:52:48', '0');
...
INSERT INTO `sys_permission` VALUES ('700b7f95165c46cc7a78bf227aa8fed3', '08e6b9dc3c04489c8e1ff2ce6f105aa4', '性能监控', '/monitor', 'layouts/RouteView', null, null, '1', null, '5.00', '0', null, '1', '0', '0', null, 'admin', '2019-04-02 11:34:34', 'admin', '2019-04-02 11:35:20', '0');
...
INSERT INTO `sys_permission` VALUES ('7d08d3885671cf0ff1c4fe5d82fcd0e2', 'e41b69c57a941a3bbcce45032fe57605', 'Online图表配置', '/online/graphreport', 'modules/online/graphreport/OnlGraphreportHeadList', null, null, '1', null, '3.00', '0', null, '1', '1', '0', null, 'admin', '2019-04-10 10:33:14', 'admin', '2019-04-10 10:33:53', '0');
...
INSERT INTO `sys_permission` VALUES ('8d4683aacaa997ab86b966b464360338', 'e41b69c57a941a3bbcce45032fe57605', 'Online表单开发', '/online/cgform', 'modules/online/cgform/OnlCgformHeadList', null, null, '1', null, '1.00', '0', null, '1', '1', '0', null, 'admin', '2019-03-12 15:48:14', null, null, '0');
...
INSERT INTO `sys_permission` VALUES ('a2b11669e98c5fe54a53c3e3c4f35d14', 'f0675b52d89100ee88472b6800754a08', '类别统计报表', '/report/Analysis', 'jeecg/report/Analysis', null, '', '1', null, '1.00', '0', null, '1', '1', '0', null, 'admin', '2019-04-03 19:03:56', 'admin', '2019-04-03 19:05:26', '0');
...
INSERT INTO `sys_role_permission` VALUES ('156626a16841af0b555f1a14e663742a', 'f6817f48af4fb3af11b9e8bf182f618b', '109c78a583d4693ce2f16551b7786786', null);
...
INSERT INTO `sys_role_permission` VALUES ('1f34b6dfca7f7fa32ddcc1be4f66a6f6', 'f6817f48af4fb3af11b9e8bf182f618b', '54097c6a3cf50fad0793a34beff1efdf', null);
...
INSERT INTO `sys_role_permission` VALUES ('216da985b3320291f04700ee0f0a73ad', 'f6817f48af4fb3af11b9e8bf182f618b', 'e41b69c57a941a3bbcce45032fe57605', null);
...
INSERT INTO `sys_role_permission` VALUES ('6d1c178aa13da836bc87a38a87331878', 'f6817f48af4fb3af11b9e8bf182f618b', '8d4683aacaa997ab86b966b464360338', null);
...
INSERT INTO `sys_role_permission` VALUES ('c78f031eb9a2ce9caa2af4ea31741940', 'f6817f48af4fb3af11b9e8bf182f618b', '9fe26464838de2ea5e90f2367e35efa0', null);
...
INSERT INTO `sys_role_permission` VALUES ('ef12e8b78d6b1d345ea5d2b48ba6f9e6', 'f6817f48af4fb3af11b9e8bf182f618b', '7d08d3885671cf0ff1c4fe5d82fcd0e2', null);
...
CREATE TABLE `sys_sms` (
  ...
  `es_type` varchar(1) default NULL COMMENT '推送方式：1短信 2邮件 3微信',
  `es_receiver` varchar(50) default NULL COMMENT '接收人',
  `es_param` varchar(1000) default NULL COMMENT '推送所需参数Json格式',
